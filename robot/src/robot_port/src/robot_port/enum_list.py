...
cmd_list = {"stop", "停止", "终止", "停止实验", "终止实验", "spin", "旋转", "开始旋转", "原地旋转", "stop spinning", "停止旋转", "终止旋转", "结束旋转", "look me", "看我", "转过来", "看过来", "嗨",\
	"come here", "过来", "走过来", "快过来", "来", "到这来", "move to origin", "回到原点", "回原点", "回去", "回去原点", "去原点"}
